function geti(a){if(document.getElementById(a))return document.getElementById(a);console.warn(a,"not found")}userfield=geti("userfield");passfield=geti("passfield");loginbutton=geti("loginbutton");loginregscreen=geti("loginregpage");createaccbutton=geti("createaccbutton");gotologinbut=geti("gotologinbut");reguserfield=geti("reguserfield");regpassfield=geti("regpassfield");valregpassfield=geti("validationregpassfield");
...
function checkHash(){if("#register"==window.location.hash)return loginregscreen.setAttribute("screen","register"),document.title="Registration - Projec.cc","changing to registration";if("#login"==window.location.hash)return loginregscreen.setAttribute("screen","login"),document.title="Welcome to Projec.cc","changing to login"}window.onload=function(){checkHash()};window.onhashchange=function(){checkHash()};
